...
<!-- All of this "flash" code is for showing if a character has been sucessfully or unsuccessfully deleted.
It "flashes" a variable and temorarily stores it in the session - it's gone after the user refreshes
so it's useful for showing temporary alerts. -->
